...
export default function Checkout() {
  ...
  return (
    <div className="bg-[#f8f9ff] min-h-screen font-geist">
      <AuthNavbar />
      <main className="max-w-7xl mx-auto px-5 md:px-16 pt-32 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          {/* Left: Checkout Form */}
          <div className="lg:col-span-2 space-y-8">
            <div>
              <h1 className="font-bold text-4xl text-[#0b1c30] mb-2" style={{ fontFamily: 'Montserrat' }}>Complete Your Order</h1>
            ...
            <section className="bg-white rounded-xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-[#e4beba]/30">
              <div className="flex items-center gap-3 mb-7">
                ...
                <h2 className="font-bold text-xl text-[#0b1c30]" style={{ fontFamily: 'Montserrat' }}>Address Details</h2>
              </div>
            ...
            <section className="bg-white rounded-xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-[#e4beba]/30">
              <div className="flex items-center gap-3 mb-7">
                ...
                <h2 className="font-bold text-xl text-[#0b1c30]" style={{ fontFamily: 'Montserrat' }}>Delivery Slot</h2>
              </div>
            ...
            <section className="bg-white rounded-xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-[#e4beba]/30 opacity-60 pointer-events-none">
              <div className="flex items-center gap-3 mb-7">
                ...
                <h2 className="font-bold text-xl text-[#5b403e]" style={{ fontFamily: 'Montserrat' }}>Payment Method</h2>
              </div>
            ...
            <button className="w-full md:w-auto bg-gradient-to-r from-orange-500 to-[#b61722] text-white font-semibold text-sm px-12 py-5 rounded-xl shadow-lg hover:shadow-xl active:scale-[0.98] transition-all flex items-center gap-2">
          ...
          <aside className="sticky top-28 space-y-5">
            <div className="bg-[#111827] text-white rounded-2xl p-8 shadow-2xl relative overflow-hidden">
              ...
              <h3 className="font-bold text-xl mb-6" style={{ fontFamily: 'Montserrat' }}>Order Summary</h3>
              <div className="space-y-5">
                ...
                <div className="pt-5 border-t border-white/20 flex justify-between items-end">
                  <div>
                    ...
                    <p className="font-bold text-3xl text-white" style={{ fontFamily: 'Montserrat' }}>₹3,550</p>
                  </div>
